...
//     <a href="https://www.google.com"><button className="bg-[#0068C8] text-gray-50 ml-[7%] mt-4 uppercase py-2 w-52 rounded hover:bg-white hover:border font-semibold  hover:border-[#0068C8] hover:text-[#0068C8] transition duration-300">Back to homepage</button></a>
// </div>
//   )
// }
