      ...
      <div>
        <div className='flex flex-row justify-center items-center gap-7'>
          <div className='relative'>
            <img src={image1} alt="" className='rounded-xl h-[600px] w-[700px]'/>
          ...
          <div className='relative mr-10 '>
            <img src={image2} alt="" className=' rounded-xl h-[600px] w-[700px]'/>
            <div className='absolute top-0 left-0 w-full flex flex-col items-center mt-12   '>
